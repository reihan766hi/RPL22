...
<div class="login-box">
  <div class="login-logo">
    <a href="admin/index2.html"><b>Shutle</b>Bus</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="/postregister" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control {{$errors->has('name') ? ' is-invalid' : ''}}" name="name" placeholder="Nama">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control {{$errors->has('username') ? ' is-invalid' : ''}}" name="username" placeholder="Username">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-user"></span>
              </div>
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group mb-3">
            <input type="text"class="form-control {{$errors->has('alamat') ? ' is-invalid' : ''}}" name="alamat" placeholder="Alamat">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3 date" id="reservationdate" data-target-input="nearest">
            <input type="text" class="form-control datetimepicker-input {{$errors->has('tgl_lahir') ? ' is-invalid' : ''}}" data-target="#reservationdate" name="tgl_lahir" placeholder="Tanggal Lahir">
          ...
          <div class="input-group mb-3">
            ...
            <input type="hidden" class="form-control" name="role" value="pemesan">
            <div class="input-group-append">
              <div class="input-group-text">
